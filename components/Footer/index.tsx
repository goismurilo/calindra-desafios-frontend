    ...
    return (
        <footer className='md:flex md:justify-center'>
            ...
            <div className='max-w-7xl mx-auto px-4 pt-16 pb-2 md:text-left lg:px-8 items-center text-center'>
                <span className='font-bold text-3xl text-primary-text'>Follow Us</span>
            ...
            <div className='max-w-7xl md:w-6/12 mx-auto md:m-0  px-4 md:pt-16 text-center md:text-left lg:px-8 items-center'>
                <span className='font-bold text-3xl text-primary-text'>Contact</span>
                <div className='py-6'>
                    <p className='font-normal text-primary-text text-lg'>2490 Leisure Lane<br />
                        San Luis Obispo<br />
                        California</p>
                </div>
            </div>
